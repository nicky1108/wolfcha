...
RUN npm config set registry "$NPM_REGISTRY" && npm install -g pnpm@10.32.1
...
ARG NEXT_PUBLIC_AUDIO_ASSET_BASE_URL
...
ENV NEXT_PUBLIC_AUDIO_ASSET_BASE_URL=$NEXT_PUBLIC_AUDIO_ASSET_BASE_URL
